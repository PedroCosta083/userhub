...
import com.userhub.userhub.application.usecases.user.deactive.DTOS.DeactiveUserRequest;
import com.userhub.userhub.application.usecases.user.deactive.DTOS.DeactiveUserResponse;
...
public class DeactiveUserUseCase implements BaseUseCaseInterface<DeactiveUserRequest, DeactiveUserResponse> {
    ...
    @Override
    public CompletableFuture<DeactiveUserResponse> execute(DeactiveUserRequest input) {
        if (input == null) {
